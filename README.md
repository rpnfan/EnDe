...
The screenshots are taken from the analyzer from Cyanophage and give a first impression how the layout fares. I compare the layouts to Graphite, which is at the moment a layout often suggested. That works good in English and also reasonably well for German. Try out both on some common English and German words and see which you like better. The statistics are helpful to rule out bad layouts, but will not help you to decide for your personal favorite one!
